...
from img_tools import loadimage, convert_image_to_8bit, rotate90c, picheral_median, Lut, minAndMax
from img_tools_2 import convert_16bit_image_to_8bit_min_max, picheral_median_2
...
def Zooscan_convert(from_file: Path, to_file: Path, lut: Lut):
    ...
    (marc_median, marc_mean) = picheral_median_2(raw_image)
