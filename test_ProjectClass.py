...
class Test_ProjectClass(unittest.TestCase):
    ...
    def test_temp_ProjectClass(self):
        ...
        self.assertEqual(testFolder.as_posix(),"/Users/sebastiengalvagno/piqv/plankton/zooscan_lov/Zooscan_iado_wp2_2020_sn001/Test")
    ...
    def test_folder(self):
        ...
        self.assertEqual(Path(TP.testfolder).as_posix(), "/Users/sebastiengalvagno/piqv/plankton/zooscan_lov/Zooscan_iado_wp2_2020_sn001/Test")
