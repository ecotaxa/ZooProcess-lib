...
def splitimage(image, histolut) -> list:
    ...
    cropped.append(pieceImage(image, image.shape[1]//2, image.shape[0]//4,   image.shape[0]//mult, image.shape[1]//2, histolut))
    cropped.append(pieceImage(image, image.shape[1]//2, 2*image.shape[0]//4, image.shape[0]//mult, image.shape[1]//2, histolut))
    cropped.append(pieceImage(image, image.shape[1]//2, 3*image.shape[0]//4, image.shape[0]//mult, image.shape[1]//2, histolut))
...
def convertion(image: np.ndarray, sample: str , TP: ProjectClass ):
...
def convertion2(image: np.ndarray, sample: str , TP: ProjectClass ):
    import cv2
